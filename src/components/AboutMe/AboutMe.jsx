      ...
      <div className="about-me__container">
        <div className="about-me__info">
          ...
          <p className="about-me__text">
            Я родился в Моздоке, на данный момент в Пятигорске, закончил военный институт ВВВУТ в г. Вольске.
            После окончания военного института я прослужил еще 10 лет и ушёл на военную пенсию.
            Появилась возможность найти себя в жизни, и я решил обучиться на веб-разработчика, это затянул.
